...
#define EEFS_LIB_EEPROM_WRITE(Dest, Src, Length) /*memcpy(Dest, Src, Length)*/   eefs_write(Dest, Src, Length)
#define EEFS_LIB_EEPROM_READ(Dest, Src, Length)  /*memcpy(Dest, Src, Length)*/    eefs_read(Dest, Src, Length)
